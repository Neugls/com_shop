...
class ShopModelCustomers extends JModelAdmin
{
    /**
	...
	{
		if($form = $this->loadForm('com_shop.customers', 'customers', array('control'=>'jform', 'load_data'=>$loadData))){
			return $form;
		}
		JError::raiseError(0, JText::sprintf('JLIB_FORM_INVALID_FORM_OBJECT', 'customers'));
		return null;
	}
